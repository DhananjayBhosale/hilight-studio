...
> Highlight Studio controls the supported phone's eight-LED HiLight array. It does not root the device
...
> When the user enables a "while this app is open" rule or a face-down condition, Highlight Studio runs
